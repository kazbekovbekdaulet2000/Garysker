...
export class BackgroundImageDirective implements AfterViewInit, OnChanges {
  ...
  @Input() blur: string;
  @Input() temp: 'cover' | 'cover_480p' | 'avatar' = 'cover_480p';
  ...
  tempImg = {
    ...
    cover_480p: './assets/images/dummy-image.png',
    avatar: './assets/images/stickers/garyshker.png'
  };
  ...
  setBackgroundImage() {
    ...
    if(this.blur){
      this.renderer.setStyle(this.htmlElement, 'filter', this.blur)
    }
